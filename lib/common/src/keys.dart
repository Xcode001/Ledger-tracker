...
class ArchSampleKeys {
  ...
  static final chooseRoleScreen = const Key('__chooseRoleScreen__');
  static final addOrderFab = const Key('__addOrderFab__');
  static final snackbar = const Key('__snackbar__');
  static final retailerCard = const Key('__retailerCard__');
  static final supplierCard = const Key('__supplierCard__');
  static Key snackbarAction(String id) => Key('__snackbar_action_${id}__');

  // Orders
  static final orderList = const Key('__orderList__');
  static final ordersLoading = const Key('__ordersLoading__');
  static final usersLoading = const Key('__usersLoading__');
